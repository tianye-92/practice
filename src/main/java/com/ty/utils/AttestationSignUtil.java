...
//        // 验证是否存在
//        String parameterCustomerAppId = request.getParameter(CustomerConstant.REQUEST_PARAMETER_CUSTOMER_ID);
//        verifyException(parameterCustomerAppId, ResponseCodeEnum.RETURN_CODE_100701);
//        String parameterSign = request.getParameter(CustomerConstant.REQUEST_PARAMETER_SIGN);
//        verifyException(parameterSign, ResponseCodeEnum.RETURN_CODE_100702);
//        // 客户id
//        String customerAppId = StringUtils.EMPTY;
//        // 请求签名
//        String sign = StringUtils.EMPTY;
//        try {
//            customerAppId = URLDecoder.decode(parameterCustomerAppId, CustomerConstant.INPUT_CHARSET);
//            sign = URLDecoder.decode(parameterSign, CustomerConstant.INPUT_CHARSET);
