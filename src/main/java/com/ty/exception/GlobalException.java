...
public class GlobalException extends RuntimeException {
    ...
    public GlobalException(ResultEnum responseCodeEnum){
        this(responseCodeEnum.getCode(), responseCodeEnum.getMessage(), true);
    }

    public GlobalException(ResultEnum responseCodeEnum, String msg){
