...
/**
 * 对于自定义注解所做的操作，使用Spring AOP 拦截该注解，然后使用反射技术获取所有使用该注解的方法做校验
 */
@Aspect
@Component
        ...
        if(require.parameter() == String.class){
        	...
        	for(String fieldName:fieldNames.split(",")){
                ...
                if(map.get(fieldName) == null || StringUtils.isBlank(String.valueOf(map.get(fieldName)))){
                	throw new GlobalException(ResultEnum.RESULT_CODE_100403, Utils.i18n("参数") + "：" + fieldName + " " + Utils.i18n("不允许为空"));
                }
            }
